...
assert.deepStrictEqual(parseArgs(['--limit=2']), { limit: 2, row: null, rows: null, resume: false, resetPassword: false, regenerateKey: false });
console.log('✓ --limit=2 parsed');

assert.deepStrictEqual(parseArgs(['--row=7']), { limit: Infinity, row: 7, rows: null, resume: false, resetPassword: false, regenerateKey: false });
console.log('✓ --row=7 parsed');

assert.deepStrictEqual(parseArgs(['--row=7', '--limit=1']), { limit: 1, row: 7, rows: null, resume: false, resetPassword: false, regenerateKey: false });
...
assert.deepStrictEqual(parseArgs(['--regenerate-key', '--rows=2,5,6']), {
  limit: Infinity, row: null, rows: [2, 5, 6], resume: false, resetPassword: false, regenerateKey: true,
});
